              ...
              <FormControl>
                <div className='relative flex w-full items-center text-black'>
                  <Input
                    ...
                    {...field}
                    className='h-8 w-full rounded-full border-2 border-black !bg-transparent pr-10 placeholder:text-black/30 lg:h-[70px] lg:w-[1000px] lg:pr-12'
                  />
                  ...
                  <button type='submit' className='absolute right-2 lg:right-3'>
                    <Search className='size-[18px] lg:size-10' />
